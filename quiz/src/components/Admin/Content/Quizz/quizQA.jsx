...
import { getAllQuizForAdmin, getQuizWithQA, postQuizUpsertQA } from "../../../../services/apiService";
...
const QuizQA = () => {
    ...
    //return file object from base64 string
    ...
    return (
        <div className="max-w-3xl mx-auto p-6 space-y-6 bg-white shadow-md rounded-xl overflow-hidden">
